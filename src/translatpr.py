...
from models.languges import SOURCE_FILE_2_DEEPL_MAP, SourceLangsCodes, DEEPL_2_SOURCE_FILE_MAP
...
def translate_text(text: str, source_file_lang: SourceLangsCodes, target_lang: str) -> str:
